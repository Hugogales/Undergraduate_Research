...
class Player:
    ...
    def draw(self, surface):
        ...
        # rotate the legs based on the direction
        rotated_left_leg = pygame.transform.rotate(left_leg_scaled, -new_direction)
        rotated_right_leg = pygame.transform.rotate(right_leg_scaled, -new_direction)
        ...
        surface.blit(rotated_left_leg, right_leg_rect)
